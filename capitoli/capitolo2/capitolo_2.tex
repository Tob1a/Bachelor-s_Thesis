...
di 100 alberi per Foresta (infatti indipendentemente dal superamento di questa soglia la bontà del modello non aumentava) e non è stato impostato un vincolo 
